...
const GOOGLE_FONTS_MAP = {
  ...
  'raleway': { weights: [400, 700], urlName: 'Raleway' },
  'poppins': { weights: [400, 700], urlName: 'Poppins' },
  'archivo': { weights: [400, 700], urlName: 'Archivo' },
  'archivo-narrow': { weights: [400, 700], urlName: 'Archivo+Narrow' },
  'barlow-semi-condensed': { weights: [400, 700], urlName: 'Barlow+Semi+Condensed' },
  'alumni-sans': { weights: [400, 700], urlName: 'Alumni+Sans' },
  'arimo': { weights: [400, 700], urlName: 'Arimo' },
  
  // Serif
  'playfair-display': { weights: [400, 700], urlName: 'Playfair+Display' },
  'merriweather': { weights: [400, 700], urlName: 'Merriweather' },
  'lora': { weights: [400, 700], urlName: 'Lora' },
  'abril-fatface': { weights: [400], urlName: 'Abril+Fatface' },
  'antic-slab': { weights: [400], urlName: 'Antic+Slab' },
  'bellota': { weights: [400, 700], urlName: 'Bellota' },
  
  // Display
  'bebas-neue': { weights: [400], urlName: 'Bebas+Neue' },
  'oswald': { weights: [400, 700], urlName: 'Oswald' },
  ...
  'caveat': { weights: [400, 700], urlName: 'Caveat' },
  'kalam': { weights: [400, 700], urlName: 'Kalam' },
  'satisfy': { weights: [400], urlName: 'Satisfy' },
  'amatic-sc': { weights: [400, 700], urlName: 'Amatic+SC' },
  
  // Monospace
  'roboto-mono': { weights: [400, 700], urlName: 'Roboto+Mono' },
  'source-code-pro': { weights: [400, 700], urlName: 'Source+Code+Pro' },
  'ibm-plex-mono': { weights: [400, 700], urlName: 'IBM+Plex+Mono' },
